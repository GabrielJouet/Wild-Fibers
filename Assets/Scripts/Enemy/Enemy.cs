...
public class Enemy : MonoBehaviour
{
    ...
    protected List<DotInfo> _dots = new List<DotInfo>();
    ...
    {
        IsDotted = true;
        DotInfo buffer = new DotInfo(duration, armorThroughMalus, healthMalus);
        _dots.Add(buffer);
    ...
    protected IEnumerator TakePersistentDamage(DotInfo newDot)
    {
