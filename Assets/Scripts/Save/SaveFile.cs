...
namespace Save
{
    ...
    public class SaveFile
    {
        ...
        /// Current squad used.
        /// </summary>
        public SquadProgression CurrentSquad => SquadsProgression[0];

        /// <summary>
        /// Current save of the current squad.
        /// </summary>
        public List<LevelSave> CurrentSave => SquadsProgression[0].Saves;
        ...
        {
            LevelState lastLevelState = CurrentSave[^1].State;
