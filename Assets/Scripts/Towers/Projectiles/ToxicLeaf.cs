...
namespace Towers.Projectiles
{
    ...
    public class ToxicLeaf : Projectile
    {
        ...
        public void Initialize(Vector2 newPosition, bool slowDown)
        {
            ...
            transformComponent.position = _initialPosition;
            transformComponent.localScale = new Vector3(1, 1, 1);

            _slowDown = slowDown;

            _rotationSpeed = Random.Range(0.5f, 1.5f) * (Random.Range(0, 2) == 1 ? -1 : 1);
        }
        ...
        protected override void Update()
        {
            ...
            else
            {
                ...
                transformComponent.localPosition = _initialPosition + new Vector2(Mathf.Sin(_angle) * 0.15f, Mathf.Cos(_angle) * 0.15f);
                transformComponent.RotateAround(transformComponent.position, Vector3.forward, projectileSpeed * 4 * Time.deltaTime);
            }
        }
